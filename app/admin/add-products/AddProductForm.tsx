...
const AddProductForm = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = async(data) =>{
        ...
        const handelImageUploads = async()=>{
            ...
            try {
                for(const item of data.images) {
                    if (item.image) {
                        ...
                        //Everything waits untill this gets executed (promise benefits)
    ...
    return (  
        ...
        <CustomCheckBox id="inStock" register={register} label="Product is in stock"/>
            ...
            <div className=" w-full flex flex-col flex-wrap gap-4">
                ...
                <div className=" grid grid-cols-2 gap-3">
                    {colors.map((item,index) => {
                        return <SelectColors key={index} item={item} addImageToState={addImageToState} removeImageFromState={removeImageFromState} isProductCreated={isproductCreated} />
                    })}
                </div>
            </div>
